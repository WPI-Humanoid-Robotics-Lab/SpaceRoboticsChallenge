...
#include <perception_common/color_laser.h>
...
ColorLaser::ColorLaser(ros::NodeHandle& nh):
    color_image_(),
    camera_info_(),
...
void ColorLaser::startStreaming()
{
    ...
    {
        color_image_sub_      = node_handle_.subscribe("/multisense/camera/left/image_rect_color",
                                                       10,
                                                       &perception_common::ColorLaser::colorImageCallback,
                                                       this);

        camera_info_sub_      = node_handle_.subscribe("/multisense/camera/left/camera_info",
                                                       10,
...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        perception_common::ColorLaser colorLaserPublisher(nh);
