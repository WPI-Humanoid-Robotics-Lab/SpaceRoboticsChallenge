...
std::vector<ArmControlInterface::armTaskSpaceData> *arm_data;
geometry_msgs::PoseStamped center_pose, edge_pose;
int execute_angle;
ros::Publisher array_pub;
tf::TransformListener* listener;
ArmControlInterface *right_armTraj,*left_armTraj;
...
std::vector<ArmControlInterface::armTaskSpaceData>* generate_task_space_data(std::vector<geometry_msgs::PoseStamped*>* input_poses, RobotSide input_side, float desired_time=6.0f);
